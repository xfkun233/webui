...
```bash
adb shell "cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/quectel-rgmii-toolkit/SDXLEMUR/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh" && cd /
```
...
Then run
```
cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd /
```
**You should see:**
