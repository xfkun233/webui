...
ensure_entware_installed() {
    ...
    if [ ! -f "/opt/bin/opkg" ]; then
        ...
        cd /tmp && wget --no-check-certificate -O installentware.sh "https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/installentware.sh" && chmod +x installentware.sh && ./installentware.sh
        if [ "$?" -ne 0 ]; then
...
set_simpleadmin_passwd(){
	...
	wget --no-check-certificate -O /usrdata/root/bin/htpasswd https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleadmin/htpasswd && chmod +x /usrdata/root/bin/htpasswd
	wget --no-check-certificate -O /usrdata/root/bin/simplepasswd https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleadmin/simplepasswd && chmod +x /usrdata/root/bin/simplepasswd
	...
	echo -e "\e[0;33m3) Return to Main Menu\e[0m"
 	echo -e "\e[1;32mSelect your choice: \e[0m"
        ...
        2)
		    ...
		    wget --no-check-certificate -O /usrdata/simpleupdates/scripts/update_socat-at-bridge.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleupdates/scripts/update_socat-at-bridge.sh && chmod +x /usrdata/simpleupdates/scripts/update_socat-at-bridge.sh
			...
			sleep 1
		    wget --no-check-certificate -O /usrdata/simpleupdates/scripts/update_simplefirewall.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleupdates/scripts/update_simplefirewall.sh && chmod +x /usrdata/simpleupdates/scripts/update_simplefirewall.sh
			...
			sleep 1
			set_simpleadmin_passwd
		    wget --no-check-certificate -O /usrdata/simpleupdates/scripts/update_simpleadmin.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleupdates/scripts/update_simpleadmin.sh && chmod +x /usrdata/simpleupdates/scripts/update_simpleadmin.sh
...
echo -e "\e[1;31m2) Installing tailscale from the $GITTREE branch\e[0m"
			...
			mkdir /usrdata/simpleupdates > /dev/null 2>&1
		    mkdir /usrdata/simpleupdates/scripts > /dev/null 2>&1
		    wget --no-check-certificate -O /usrdata/simpleupdates/scripts/update_tailscale.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleupdates/scripts/update_tailscale.sh && chmod +x /usrdata/simpleupdates/scripts/update_tailscale.sh
...
configure_tailscale() {
	...
	wget --no-check-certificate -O tailscale-webui.service https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/tailscale/systemd/tailscale-webui.service
  	wget --no-check-certificate -O tailscale-webui-trigger.service https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/tailscale/systemd/tailscale-webui-trigger.service
...
install_sshd() {
    ...
    mkdir /usrdata/simpleupdates > /dev/null 2>&1
	mkdir /usrdata/simpleupdates/scripts > /dev/null 2>&1
	wget --no-check-certificate -O /usrdata/simpleupdates/scripts/update_sshd.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/simpleupdates/scripts/update_sshd.sh && chmod +x /usrdata/simpleupdates/scripts/update_sshd.sh
...
if echo "$ARCH" | grep -q "aarch64"; then
    cd /tmp && wget --no-check-certificate -O RM55x_rcPCIe_toolkit.sh https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development-SDXPINN/RM55x_rcPCIe_toolkit.sh && chmod +x RM55x_rcPCIe_toolkit.sh && ./RM55x_rcPCIe_toolkit.sh && cd /
    exit 0
    ...
    case $choice in
		...
		12) 
			...
			mkdir /usrdata/root
     	    mkdir /usrdata/root/bin
			cd /usrdata/root/bin
     	    wget --no-check-certificate -O fast https://gh-proxy.com/raw.githubusercontent.com/xfkun233/webui/main/development/fast_linux_arm && chmod +x fast
     	    cd /
